...
/datum/supply_pack/emergency/specialops
	...
	desc = "(*!&@#TOO CHEAP FOR THAT NULL_ENTRY, HUH OPERATIVE? WELL, THIS LITTLE ORDER CAN STILL HELP YOU OUT IN A PINCH. CONTAINS A BOX OF FIVE EMP GRENADES, THREE SMOKEBOMBS, AND A INCENDIARY GRENADE FULL OF FIREY DEATH!#@*$"
	hidden = TRUE
	cost = 1800
